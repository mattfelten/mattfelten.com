...
import { Asset, AssetRow, Emoji } from 'components';
...
<AssetRow items={[
	{
		src: interfaceInventoryGif,
		alt: 'Interface Inventory'
	},
	{
		src: interfaceInventory,
		alt: 'Interface Inventory'
	}
]}  />
...
## Roadmap
- <Emoji label="check mark" emoji="✅" /> Interface Inventory
- <Emoji label="check mark" emoji="✅" /> Code Tools / Documentation Site
- <Emoji label="check mark" emoji="✅" /> Design Library
- <Emoji label="pencil" emoji="✏️" /> Design System Roadmap
