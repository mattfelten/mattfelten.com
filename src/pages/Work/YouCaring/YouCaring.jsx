...
import { Asset, Emoji, Link, List, Section, SubSection } from '../../../components';
	...
	return (
		<Page>
			...
			<Section>
				...
				<SubSection type="equal">
					<Asset src={docsExample} href={docsExample} alt="Documentation Site" />
					<Asset src={docsReal} href={docsReal} alt="Documentation Site" />
				</SubSection>
