...
<CaseStudyTierDemo variant="showcase" caption="Sketch: A grid of polished screens with no surrounding text. Pure visual gallery, like a Dribbble profile or gallery wall." />
...
<CaseStudyTierDemo variant="project-feature" caption="Sketch: Hero image at top, a short hook paragraph, a couple more images, a small role block, a paragraph about the design problem, and an outcomes line. Compact and scannable." />
...
<CaseStudyTierDemo variant="case-study" caption="Sketch: A tall, dense scrolling page with many sections. Research, personas, iterations, testing, final designs, metrics. Emphasize the length, maybe a tiny scrollbar to sell it." />
