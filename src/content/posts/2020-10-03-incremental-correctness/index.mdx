...
import seniorDesignerProcess from './senior-designer-process.png';
...
<Asset src={mountain} alt="a person climbing a mountain" caption='Illustration by <a href="//marissaluca.com">Marissa Felten</a>' />
