...
The ceiling was older parts of the product that weren't under active development. Migrating them was hard to justify when there were no new features coming: the work was pure consistency, and consistency is difficult to put on a roadmap. Those areas stayed on old patterns, which is also why 71% felt like both a win and an unfinished sentence.
