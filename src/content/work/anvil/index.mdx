...
import productScreen1Img from './product-screen-1.png';
import productScreen2Img from './product-screen-2.png';
import productScreen3Img from './product-screen-3.png';
import productScreen4Img from './product-screen-4.png';
...
<AssetRow>
	<Asset src={productScreen1Img} alt="ServiceTitan product screen built with Anvil components" />
	<Asset src={productScreen2Img} alt="ServiceTitan product screen built with Anvil components" />
</AssetRow>

<AssetRow>
	<Asset src={productScreen3Img} alt="ServiceTitan product screen built with Anvil components" />
	<Asset src={productScreen4Img} alt="ServiceTitan product screen built with Anvil components" />
</AssetRow>
