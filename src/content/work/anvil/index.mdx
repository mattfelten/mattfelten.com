...
Year one was just me and one engineer. Year two I hired the first Design Technologist. Someone strong at design who could also build React components, think critically about details, and explain rationale to both designers and engineers. Year three brought a second Design Technologists. Year four, I got engineering investment for two part-time dedicated engineers.
...
By 2022, the system served 385 users across 32 teams on three platforms: web, iOS, and Android.
...
<Stats>
	...
	<Stat value="250K" label="Lines of code, 5,000 NPM installs per week" />
	<Stat value="77%" label="Customer satisfaction score" />
	<Stat value="37" label="Contributors from across the company" />
	<Stat value="385" label="Users across design and engineering" />
	<Stat value="32" label="Product teams served across web, iOS, and Android" />
</Stats>
