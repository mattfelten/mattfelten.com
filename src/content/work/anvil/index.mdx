...
<div style="background: #f0f0f0; border: 2px dashed #999; padding: 3rem 2rem; text-align: center; margin: 2em 0; border-radius: 8px;">
	<strong style="display: block; margin-bottom: 0.5rem;">IMAGE: Component Audit</strong>
	<span style="color: #666;">Artboard showing the scale of UI inconsistency across the product. Multiple button styles, form patterns, and navigation treatments side by side.</span>
</div>
...
<div style="background: #f0f0f0; border: 2px dashed #999; padding: 3rem 2rem; text-align: center; margin: 2em 0; border-radius: 8px;">
	<strong style="display: block; margin-bottom: 0.5rem;">IMAGE: Code-to-Design Pipeline</strong>
	<span style="color: #666;">Diagram showing the workflow: React components → html-sketchapp rendering → Sketch symbol library output.</span>
</div>

<div style="background: #f0f0f0; border: 2px dashed #999; padding: 3rem 2rem; text-align: center; margin: 2em 0; border-radius: 8px;">
	<strong style="display: block; margin-bottom: 0.5rem;">IMAGE: Documentation Site</strong>
	<span style="color: #666;">Screenshot of the Anvil docs landing page showing component categories and live examples.</span>
</div>
...
<div style="background: #f0f0f0; border: 2px dashed #999; padding: 3rem 2rem; text-align: center; margin: 2em 0; border-radius: 8px;">
	<strong style="display: block; margin-bottom: 0.5rem;">IMAGE: Component Explorations</strong>
	<span style="color: #666;">Messy artboard showing design exploration for a component. Multiple variations, annotations, and iteration.</span>
</div>
...
<div style="background: #f0f0f0; border: 2px dashed #999; padding: 3rem 2rem; text-align: center; margin: 2em 0; border-radius: 8px;">
	<strong style="display: block; margin-bottom: 0.5rem;">IMAGE: Release Communication</strong>
	<span style="color: #666;">Example release announcement email or slide showing how new components were communicated to the organization.</span>
</div>
