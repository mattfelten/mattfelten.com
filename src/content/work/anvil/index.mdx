...
1. STARTING POINT - Component audit artboard (shows the scale of inconsistency)
2. BUILDING THE FOUNDATION - Process diagram + Docs landing page
3. COMPONENT DEVELOPMENT - Explorations artboard (shows messy design thinking)
4. OUTCOMES - Release announcement email or new feature slide
*/}

[ServiceTitan](https://servicetitan.com/) builds software that helps tradespeople run their businesses. Plumbers, electricians, HVAC technicians. Over four years, I built and led the design system team that unified their product experience across web, iOS, and Android.

**The problem:** Engineering had accumulated three competing UI frameworks. Bootstrap in some places, Semantic UI in others, Material Design in the rest. Design had loose typography and color guidelines but no shared component language. Engineers had to learn multiple frameworks to do their jobs. Designers went with what looked good rather than what was buildable. Every handoff was a negotiation.
...
{/* TODO: Component audit artboard - shows the scale of UI inconsistency across the product */}
...
{/* TODO: Process diagram - shows the workflow for building components */}

{/* TODO: Docs landing page - shows the polished documentation site output */}
...
{/* TODO: Explorations artboard - shows the messy design thinking process */}
...
{/* TODO: Release announcement email or new feature slide - shows the communication/adoption work */}
