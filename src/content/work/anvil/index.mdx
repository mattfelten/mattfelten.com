...
import productDashboardImg from './product-dashboard.png';
import productOnboardingImg from './product-onboarding.png';
import productTitanCenterImg from './product-titan-center.png';
...
<div class="not-prose my-8 grid gap-4 md:grid-cols-2">
	<Card title="Before">
		Three competing UI frameworks, no shared component language, every design handoff a negotiation
	</Card>
	<Card title="After" accent>
		One unified system, code as source of truth, 385 users across 32 product teams
	</Card>
</div>
