...
<AssetRow caption="Two of the conceptual screens from the pitch. They didn't match what we eventually built. The Dashboard came later, the Customers page evolved substantially, AWS Accounts wasn't even in the first concept. But seeing the app made the idea land in a way a pitch doc by itself couldn't have.">
	<Asset
		src={conceptDashboard}
		alt="A rough conceptual dashboard from the pitch, showing customer activity and team data"
		expand
	/>
	<Asset
		src={conceptCustomers}
		alt="A rough conceptual customers page from the pitch, showing a list of customers with quick details"
		expand
	/>
</AssetRow>
...
<div class="not-prose my-8 grid gap-4 sm:grid-cols-2">
	...
	<Card title="Shared design system">
		Extract UI components into a shared library that both apps would
		consume. Same components, same visual language, one source of truth.
	</Card>
...
<Card title="Monthly Active Users" class="my-8">
	<span class="text-subdued -mt-1 mb-2 text-xs">2024 - 2026</span>
	<UsageChart
		client:only="react"
		data={[
